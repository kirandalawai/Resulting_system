...
if($_SESSION['alogin']==true)
{
  if(isset($_POST['submit']))
  {
       ...
       // ['lawyer_details.lawyer_name'=>1,'lawyer_details.appearing_for'=>1,"judge_details.judge_id"=>1,
        ...
        {
          //echo "$rows->Name";
          //print_r ($rows->Exam_details->reg_no)."<br>";
           //print_r ($rows->Exam_details->Marks_obtained->logical_reasoning)."<br>";
            //print_r ($rows->Exam_details->reg_no);
          var_dump($rows);
          echo "<br>";
        }
        if($row)
...
<a href="agg1.php">Eligible candidates</a><br><br><br><br>
